const stylesData = [
  ...
  },
  {
    ...
    features: [
      ...
      "**半色調網點陰影**：使用 Halftone dot texture 表現陰影與質感，復古且獨特。",
  ...
  },
  {
    ...
    features: [
      ...
      "**有限調色盤 (3-4色)**：使用高度簡化的配色，展現懷舊質感。",
      "**絲網印刷紋理**：畫面帶有細微的印刷顆粒與不完美的復古感。",
  ...
  },
  {
    ...
    features: [
      ...
      "**色彩編碼分類**：運用不同的線條顏色區分不同類別或專業路徑，層級清晰。",
  ...
  },
  {
    ...
    features: [
      ...
      "**精緻曲線線條**：充滿繁複且優雅的曲線與漩渦圖案，風格柔美且精緻。",
  ...
  },
  {
    ...
    features: [
      ...
      "**整齊有序擺放**：物件經過精心排列，呈現出網格化或對稱的秩序美感。",
  ...
  },
  {
    ...
    features: [
      ...
      "**精緻可愛細節**：物件造型圓潤且細節豐富，呈現出高品質的 3D 渲染質感。",
